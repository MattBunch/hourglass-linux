...
{
    [Fact]
    public void CreateX11PlatformOptionsPrefersAcceleratedRenderingWhenDri3IsAvailable()
    {
        X11PlatformOptions options = Program.CreateX11PlatformOptions(isDri3Available: true);
    ...
    [Fact]
    public void CreateX11PlatformOptionsSelectsSoftwareRenderingWhenDri3IsUnavailable()
    {
        X11PlatformOptions options = Program.CreateX11PlatformOptions(isDri3Available: false);
    ...
    {
        X11PlatformOptions first = Program.CreateX11PlatformOptions(isDri3Available: false);
        X11PlatformOptions second = Program.CreateX11PlatformOptions(isDri3Available: false);
